% squircles_paris
    ...
    if ~exist('experiment','var')
        ...
        experiment.SR = 0;%round(rand);                                       % mouse button
    ...
    try
        ...
        switch(experiment.SR)
            case 0
                Screen(w,'DrawText','SQ/RED + CIR/BLUE (left button) or SQ/BLUE + CIR/RED (right button)',      300,350,            stimulus.whitecol);
            case 1
                Screen(w,'DrawText','SQ/BLUE + CIR/RED (left button) or SQ/RED + CIR/BLUE (right button)',      300,350,            stimulus.whitecol);
        end
