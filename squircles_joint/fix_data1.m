...
% subjects' file names
lsdata = regexp(ls('olddata_1'),'\s','split');
i = 1;
...
for i_subjects = 1:nb_subjects
    % load ----------------------------------------------------------------
    load(['olddata_1/',lsdata{i_subjects}]);
    ...
    % save
    save(['data_1',filesep,participant.filename{2},'_',num2str(participant.filename{3}),'.mat'],'conditions','data','experiment','participant','stimulus','variables');
end
